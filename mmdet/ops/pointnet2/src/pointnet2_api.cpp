...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("ball_query_wrapper_fast_repeat", &ball_query_wrapper_fast_repeat, "ball_query_wrapper_fast_repeat");
    m.def("grid_query_wrapper_fast", & grid_query_wrapper_fast, "grid_query_wrapper_fast");
    m.def("grid_points_wrapper", & grid_points_wrapper_fast, "grid_points_wrapper_fast");
    m.def("grid_points_grad_wrapper", & grid_points_grad_wrapper_fast, "grid_points_grad_wrapper_fast");
