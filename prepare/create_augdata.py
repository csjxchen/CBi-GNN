...
from dets.tool.bbox3d.geometry import remove_outside_points, points_in_rbbox, box_camera_to_lidar
# import  as kitti
import dets.tools
...
def _calculate_num_points_in_gt(data_path, infos, relative_path, remove_outside=True, num_features=4):
    for info in infos:
        ...
        P2 = info['calib/P2']
        if remove_outside:
            # remove point clouds outsize camera's sight
            points_v = remove_outside_points(points_v, rect, Trv2c, P2,
                                                        info["img_shape"])
        
        # points_v = points_v[points_v[:, 0] > 0]
        annos = info['annos']
        # normally the objs named DontCare are tailed
        ...
        # calculated the valid points' size
        num_points_in_gt = indices.sum(0)
        num_ignored = len(annos['dimensions']) - num_obj
        # if encountering the obj is named DontCare, set -1 
...
def create_groundtruth_database(data_path,
    ...
    Args:
        ...
        coors_range ([type], optional): [description]. Defaults to None.
    ...
    print('processing database_save_path:{} || db_info_save_path:{}'.format(database_save_path, db_info_save_path))
...
if __name__ == '__main__':
    # create_kitti_info_file('../PointRCNN/data/KITTI/object')
    # create_reduced_point_cloud('../PointRCNN/data/KITTI/object')
    ...
    # create_groundtruth_database(data_path='../PointRCNN/data/KITTI/object', \
    #                             info_path='../PointRCNN/data/KITTI/object/kitti_infos_val.pkl', \
    #                             db_info_save_path='../PointRCNN/data/KITTI/object/kitti_dbinfos_val.pkl')