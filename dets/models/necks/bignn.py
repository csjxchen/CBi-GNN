...
class BiGNN_V1(nn.Module):
    def __init__(self, num_input_features, use_voxel_feature=False):
        ...
        self.conv14_structured_forward = partial(structured_forward, grouper=self.grouper_conv14,
                                                 lr_voxel_size=[0.4, 0.4, 1.0], hr_voxel_size=[0.05, 0.05, 0.1],
                                                 offset=(0., -40., -3.))
    ...
    def forward(self, x, points_mean, **kwargs):
        ...
        structured_conv4 = self.cat_sparse_features([structured_feats14, structured_feats24, structured_feats34],
                                                    x_conv4)
        # for detection head        
        # [200, 176, 5] -> [200, 176, 2]
